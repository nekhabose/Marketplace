...
public class ViewOrdersBuyerController {
	...
	private void setupTableColumns() {
		...
		userID.setCellValueFactory(cellData -> new ReadOnlyObjectWrapper<>(SessionManager.getCurrentUserId())); // Dynamically
																												// fetches
																												// and
																												// displays
																												// the
	...
	private void cancelOrder(ActionEvent event) {
		...
		if (orderDao.cancelOrder(selectedOrder.getOrderId(), selectedOrder.getProductId(),
